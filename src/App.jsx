        ...
        <nav id="primary-navigation" className="site-navigation">
            <div className="container">
                <div className="navbar-header page-scroll">
                    ...
                    <a href="#hero" className="site-logo"><img src="/public/assets/img/logo.png" alt="logo" /></a>
            ...
            <div className="container"> 
                <div className="row">
                    <div className="col-md-6 col-md-offset-3">
                        ...
                        <a href="http://www.grad.illinois.edu/sites/default/files/pdfs/cvsamples.pdf" className="btn btn-fill" target="_blank" download>Download my cv</a>
                    </div>
                </div>
            </div>
                    ...
                    <div className="col-md-4">
                        <div className="skill">
                            ...
                            <div className="progress">
                                <div className="progress-bar" role="progressbar" data-transitiongoal="100"></div> {/* /.progress-bar  */}
                            </div> {/* /.progress  */}
                        </div> {/* /.skill  */}
                        <div className="skill">
                            <h4>Python</h4>
                            <div className="progress">
                                <div className="progress-bar" role="progressbar" data-transitiongoal="75"></div> {/* /.progress-bar  */}
                            </div> {/* /.progress  */}
                        </div> {/* /.skill  */}
                    </div>
                    <div className="col-md-4">
                        <div className="skill">
                            <h4>Javascript</h4>
                            <div className="progress">
                                <div className="progress-bar" role="progressbar" data-transitiongoal="82"></div> {/* /.progress-bar  */}
                            </div> {/* /.progress  */}
                        </div> {/* /.skill  */}
                        <div className="skill">
                            <h4>Ruby</h4>
                            <div className="progress">
                                <div className="progress-bar" role="progressbar" data-transitiongoal="66"></div> {/* /.progress-bar  */}
                            </div> {/* /.progress  */}
                        </div> {/* /.skill  */}
                    </div>
                    <div className="col-md-4">
                        <div className="skill">
                            <h4>Php</h4>
                            <div className="progress">
                                <div className="progress-bar" role="progressbar" data-transitiongoal="97"></div> {/* /.progress-bar  */}
                            </div> {/* /.progress  */}
                        </div> {/* /.skill  */}
                        <div className="skill">
                            <h4>Java</h4>
                            <div className="progress">
                                <div className="progress-bar" role="progressbar" data-transitiongoal="45"></div> {/* /.progress-bar  */}
                            </div> {/* /.progress  */}
                        </div> {/* /.skill  */}
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-md-4 col-xs-6">
                        <div className="portfolio-item">
                            <img src="/public/assets/img/portfolio-1.jpg" className="img-res" alt="" />
                    ...
                    <div className="col-md-4 col-xs-6">
                        <div className="portfolio-item">
                            <img src="/public/assets/img/portfolio-2.jpg" className="img-res" alt="" />
                            <div className="portfolio-item-info">
                                <h4>Project Title</h4>
                    ...
                    <div className="col-md-4 col-xs-6">
                        <div className="portfolio-item">
                            <img src="/public/assets/img/portfolio-3.jpg" className="img-res" alt="" />
                            <div className="portfolio-item-info">
                                <h4>Project Title</h4>
                    ...
                    <div className="col-md-4 col-xs-6">
                        <div className="portfolio-item">
                            <img src="/public/assets/img/portfolio-4.jpg" className="img-res" alt="" />
                            <div className="portfolio-item-info">
                                <h4>Project Title</h4>
                    ...
                    <div className="col-md-4 col-xs-6">
                        <div className="portfolio-item">
                            <img src="/public/assets/img/portfolio-5.jpg" className="img-res" alt="" />
                            <div className="portfolio-item-info">
                                <h4>Project Title</h4>
                    ...
                    <div className="col-md-4 col-xs-6">
                        <div className="portfolio-item">
                            <img src="/public/assets/img/portfolio-6.jpg" className="img-res" alt="" />
                            <div className="portfolio-item-info">
                                <h4>Project Title</h4>
